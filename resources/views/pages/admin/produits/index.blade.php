<x-layout.admin title="Produits">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('produits.create') }}" class="btn">+ Nouveau produit</a>
    </div>
        ...
        <table class="w-full text-sm">
            <thead class="border-b border-border">
                <tr class="text-muted-foreground">
                    ...
                    <th class="text-left px-4 py-3">Seuil min</th>
            ...
            <tbody class="divide-y divide-border">
                @forelse($produits as $produit)
                    <tr class="hover:bg-border/20 transition">
                        <td class="px-4 py-3 text-muted-foreground">{{ $produit->id }}</td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3 text-muted-foreground">{{ $produit->stock_minimum }}</td>
                        <td class="px-4 py-3">
                            @if($produit->actif)
